...
ifdef WASM
	...
	CC = emcc
	CFLAGS += -DWASM
	LDFLAGS += -s ASYNCIFY -s USE_GLFW=3  -sALLOW_MEMORY_GROWTH -s EXPORTED_RUNTIME_METHODS='["requestFullscreen","HEAPF32"]' -s FORCE_FILESYSTEM=1 --shell-file $(LIB)/libraylib.html
