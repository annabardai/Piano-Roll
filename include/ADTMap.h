...
// Προσθέτει το κλειδί key με τιμή value. Αν υπάρχει κλειδί ισοδύναμο με key, τα παλιά key & value αντικαθίστανται από τα νέα.
//
// ΠΡΟΣΟΧΗ:
...
// Η σταθερά αυτή συμβολίζει έναν εικονικό κόμβο _μετά_ τον τελευταίο κόμβο του map
#define MAP_EOF (MapNode)0

typedef struct map_node* MapNode;

// Επιστρέφει τον πρώτο κόμβο του map, ή MAP_EOF αν το map είναι κενό
