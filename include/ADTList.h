...
//
// Οι τύποι αυτοί ορίζονται ως pointers στα "struct list" και "struct list_node" των οποίων το
...
// Διάσχιση της λίστας /////////////////////////////////////////////
//
// Επιστρέφουν τον πρώτο και τον τελευταίο κόμβο της λίστας, ή LIST_BOF / LIST_EOF αντίστοιχα αν η λίστα είναι κενή
...
// Βρίσκει το πρώτο στοιχείο που είναι ισοδύναμο με value (με βάση τη συνάρτηση compare).
