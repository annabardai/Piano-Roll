...
// Αφαιρεί την τιμή από το μπροστινό μέρος της ουράς (μη ορισμένο αποτέλεσμα αν η ουρά είναι κενή)
...
// Οποιαδήποτε λειτουργία πάνω στην ουρά μετά το destroy είναι μη ορισμένη.
